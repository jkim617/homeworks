...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("test","test","test") }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      ...
      expect(dessert.ingredients).to include('sauce')
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ...
      expect(dessert.ingredients).to eq(['chocolate', 'vanilla', 'icing'])
      dessert.mix!
      expect(dessert.ingredients).not_to eq(['chocolate','vanilla', 'icing'])
    end
